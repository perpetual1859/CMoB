...
class AVE_dataset(object):
    def __init__(self, path_to_dataset=r'/root/siton-data-zacharyData/VEMC/data/AVE_Dataset', frame_interval=1, frame_kept_per_second=1):
        ...
        self.path_to_save_audio = os.path.join(path_to_dataset, 'Audio-{:d}-SE-npy'.format(1004))
    ...
    def extractWav(self):
        for each_audio in self.file_list[1:]:
            ...
            save_name = os.path.join(self.path_to_save_audio, each_audio[1] + '.npy')
